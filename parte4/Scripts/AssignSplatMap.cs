        ...
        for (int y = 0; y < terrainData.alphamapHeight; y++)
        {
            for (int x = 0; x < terrainData.alphamapWidth; x++)
            {
                ...
                splatWeights[2] = ( // apply 75% only to "Mesa" uplands (NOTE: the first two textures sum 1, so 1.5 corresponds to 80%)
                    height > 0.2f * terrainData.heightmapHeight && // higher terrain
                    slope < 0.2f) // plain terrain
                        ? 1.5f : 0f;
                ...
                //switch (splatWeights.Length)
                //{
                //    case 1:
                //        splatWeights[0] = 1 - slope;
                //        break;
                //    case 2:
                //        splatWeights[1] = slope;
                //        break;
                //    case 3:
                //        splatWeights[2] = (height > 0.2f * terrainData.heightmapHeight && slope < 0.2f) ? 1.5f : 0f;
                //        break;
                //    case 4:
                //        splatWeights[3] = (height < 0.5f * terrainData.size.y && slope < 0.3f) ? 1f : 0f;
                //        break;
                //}
