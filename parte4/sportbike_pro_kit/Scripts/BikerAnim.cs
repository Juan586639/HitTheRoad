...
public class BikerAnim : MonoBehaviour
{
    ...
    private int IK_rightWeight = 4;
    private int IK_leftWeight = 4;
    ...
    public void Start()
    {
        ...
        //leftHand = GetComponent<Animator>().GetBoneTransform(HumanBodyBones.LeftHand);
    ...
    public void Update()
    {
        ...
        if (outsideControls.restartBike)
        {
            ...
            Transform riderBodyVis = transform.Find("../Animacion_Rayo_Mquen");
            Transform riderBodyVis2 = transform.Find("../Animacion_El_Zarco");
            riderBodyVis.gameObject.SetActive(true);
            riderBodyVis2.gameObject.SetActive(true);
    ...
    public void createRagDoll()
    {
        if (!ragdollLaunched)
        {
            Transform pilotHips = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips");
            Transform pilotChest = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2");
            Transform pilotHead = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:Neck/mixamorig:Head");
            Transform pilotLeftArm = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:LeftShoulder/mixamorig:LeftArm");
            Transform pilotLeftForeArm = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:LeftShoulder/mixamorig:LeftArm/mixamorig:LeftForeArm");
            Transform pilotRightArm = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:RightShoulder/mixamorig:RightArm");
            Transform pilotRightForeArm = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:RightShoulder/mixamorig:RightArm/mixamorig:RightForeArm");
            Transform pilotLeftUpperLeg = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:LeftUpLeg");
            Transform pilotLeftLeg = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:LeftUpLeg/mixamorig:LeftLeg");
            Transform pilotRightUpperLeg = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:RightUpLeg");
            Transform pilotRightLeg = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:RightUpLeg/mixamorig:RightLeg");
            ...
            riderBodyVis2.gameObject.SetActive(false);
            // creating ragdoll
            Instantiate(ragDoll, currentPilotPosition, currentPilotRotation);
            // new empty varables to fill it with learned angles later
            Transform RDpilotHips = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips");
            Transform RDpilotChest = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2");
            Transform RDpilotHead = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:Neck/mixamorig:Head");
            Transform RDpilotLeftArm = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:LeftShoulder/mixamorig:LeftArm");
            Transform RDpilotLeftForeArm = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:LeftShoulder/mixamorig:LeftArm/mixamorig:LeftForeArm");
            Transform RDpilotRightArm = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:RightShoulder/mixamorig:RightArm");
            Transform RDpilotRightForeArm = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/mixamorig:Spine2/mixamorig:RightShoulder/mixamorig:RightArm/mixamorig:RightForeArm");
            Transform RDpilotLeftUpperLeg = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:LeftUpLeg");
            Transform RDpilotLeftLeg = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:LeftUpLeg/mixamorig:LeftLeg");
            Transform RDpilotRightUpperLeg = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:RightUpLeg");
            Transform RDpilotRightLeg = transform.Find("../Animacion_Rayo_Mquen/eldavid1/mixamorig:Hips/mixamorig:RightUpLeg/mixamorig:RightLeg");
