...
public class keyboardControls : MonoBehaviour {
    ...
    public bool secondPlayerOnController;
    public float secondPlayerInput = 0;
    ...
    void Update() {
		...
		if (!Input.GetKey (KeyCode.Alpha2)) {
			outsideControls.Vertical = secondPlayerInput+ Input.GetAxis ("Vertical") / 1.112f;//to get less than 0.9 as acceleration to prevent wheelie(wheelie begins at >0.9)
